...
class MenuHoveredButton extends StatefulWidget {
  final Function onpressed;
  final bool leftBorder;
  final bool rightBorder;
  final String label;

  const MenuHoveredButton({
    Key? key,
  ...
  @override
  State<MenuHoveredButton> createState() => _MenuHoveredButtonState();
}

class _MenuHoveredButtonState extends State<MenuHoveredButton> {
